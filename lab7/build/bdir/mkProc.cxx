...
void MOD_mkProc::RL_doRest()
{
  ...
  DEF_exec___d550 = INST_instance_exec_1.METH_exec(DEF_SEL_ARR_d2r_data_0_31_BITS_75_TO_72_50_d2r_dat_ETC___d517,
						   ...
						   DEF_ppc__h31101,
						   DEF_csrVal__h31808);
  DEF_x__h33729 = primExtract32(32u, 89u, DEF_exec___d550, 32u, 65u, 32u, 34u);
  ...
  DEF_NOT_exec_50_BITS_88_TO_85_61_EQ_2_62_82_CONCAT_ETC___d588.build_concat(8589934591llu & ((((tUInt64)(!DEF_exec_50_BITS_88_TO_85_61_EQ_2___d562)) << 32u) | (tUInt64)((tUInt32)((DEF_exec_50_BITS_88_TO_85_61_EQ_2___d562 ? (primExtract64(34u,
																													       ...
																													       33u,
																													       32u,
																													       0u) << 30u) | (tUInt64)(715827882u) : (((tUInt64)(DEF_eInst_addr__h31868)) << 32u) | (tUInt64)(DEF_x__h33729)) >> 32u))),
									     32u,
									     33u).set_whole_word((tUInt32)(DEF_exec_50_BITS_88_TO_85_61_EQ_2___d562 ? (primExtract64(34u,
																				     ...
																				     33u,
																				     32u,
																				     0u) << 30u) | (tUInt64)(715827882u) : (((tUInt64)(DEF_eInst_addr__h31868)) << 32u) | (tUInt64)(DEF_x__h33729)),
												 0u);
...
void MOD_mkProc::RL_doRest2()
{
  ...
  tUInt8 DEF_rindx__h37469;
  tUInt32 DEF_val_data__h18351;
  tUInt32 DEF_data__h37470;
  ...
  DEF_rindx__h37469 = DEF_m12m2_data_0_wires_0_whas____d125 ? DEF_x__h18651 : DEF_x__h18648;
  ...
  DEF_v__h37344 = DEF_AVMeth_dCache_resp;
  DEF_data__h37470 = DEF_IF_m12m2_data_0_virtual_reg_1_read__03_THEN_0__ETC___d608 ? DEF_v__h37344 : (DEF_m12m2_data_0_virtual_reg_1_read____d603 ? 0u : DEF_val_data__h18351);
  if (DEF_NOT_m12m2_data_0_virtual_reg_1_read__03_16_AND_ETC___d620)
    INST_rf.METH_wr(DEF_rindx__h37469, DEF_data__h37470);
  INST_csrf.METH_wr(DEF_IF_m12m2_data_0_virtual_reg_1_read__03_THEN_0__ETC___d649, DEF_data__h37470);
  if (!(PORT_RST_N == (tUInt8)0u))
...
tUInt32 MOD_mkProc::METH_missCount()
{
  tUInt32 PORT_missCount;
  PORT_missCount = INST_dCache.METH_getMissCnt();
  return PORT_missCount;
}

tUInt8 MOD_mkProc::METH_RDY_missCount()
{
  tUInt8 PORT_RDY_missCount;
  tUInt8 DEF_CAN_FIRE_missCount;
  DEF_CAN_FIRE_missCount = (tUInt8)1u;
  PORT_RDY_missCount = DEF_CAN_FIRE_missCount;
  return PORT_RDY_missCount;
}

tUInt32 MOD_mkProc::METH_totalCount()
{
  tUInt32 PORT_totalCount;
  PORT_totalCount = INST_dCache.METH_getTotalReq();
  return PORT_totalCount;
}

tUInt8 MOD_mkProc::METH_RDY_totalCount()
{
  tUInt8 PORT_RDY_totalCount;
  tUInt8 DEF_CAN_FIRE_totalCount;
  DEF_CAN_FIRE_totalCount = (tUInt8)1u;
  PORT_RDY_totalCount = DEF_CAN_FIRE_totalCount;
  return PORT_RDY_totalCount;
}
