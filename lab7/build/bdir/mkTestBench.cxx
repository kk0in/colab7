...
static std::string const __str_literal_6("Cache Miss Count : %d\n", 22u);
static std::string const __str_literal_5("Cache Req Count : %d\n", 21u);
...
void MOD_mkTestBench::RL_countCycle()
{
  ...
  DEF__read__h140 = INST_cycle.METH_read();
  DEF_cycle_EQ_300000___d7 = DEF__read__h140 == 300000u;
  DEF_NOT_cycle_EQ_300000___d8 = !DEF_cycle_EQ_300000___d7;
  DEF_x__h266 = DEF__read__h140 + 1u;
  ...
  if (!(PORT_RST_N == (tUInt8)0u))
    if (DEF_NOT_cycle_EQ_300000___d8)
      dollar_display(sim_hdl, this, "s,32", &__str_literal_1, DEF__read__h140);
}
...
void MOD_mkTestBench::RL_run()
{
  ...
  tUInt32 DEF_missCount__h326;
  tUInt32 DEF_totalCount__h327;
  tUInt64 DEF_proc_cpuToHost___d12;
  tUInt64 DEF_AVMeth_proc_cpuToHost;
  DEF__read__h140 = INST_cycle.METH_read();
  DEF_totalCount__h327 = INST_proc.METH_totalCount();
  DEF_missCount__h326 = INST_proc.METH_missCount();
  ...
  if (!(PORT_RST_N == (tUInt8)0u))
  {
    ...
    if (DEF_proc_cpuToHost_2_BITS_49_TO_48_3_EQ_0___d14)
      dollar_fwrite(sim_hdl, this, "32,s,32", 2147483650u, &__str_literal_3, DEF__read__h140);
    if (DEF_proc_cpuToHost_2_BITS_49_TO_48_3_EQ_0___d14)
    ...
    if (DEF_proc_cpuToHost_2_BITS_49_TO_48_3_EQ_0___d14)
      dollar_fwrite(sim_hdl, this, "32,s,32", 2147483650u, &__str_literal_5, DEF_totalCount__h327);
    if (DEF_proc_cpuToHost_2_BITS_49_TO_48_3_EQ_0___d14)
      dollar_fwrite(sim_hdl, this, "32,s,32", 2147483650u, &__str_literal_6, DEF_missCount__h326);
    if (DEF_proc_cpuToHost_2_BITS_49_TO_48_3_EQ_0___d14)
      dollar_fwrite(sim_hdl, this, "32,s", 2147483650u, &__str_literal_2);
    if (DEF_proc_cpuToHost_2_BITS_49_TO_48_3_EQ_0___d14)
...
{
  tUInt32 DEF_signed_300000___d19;
  DEF_signed_300000___d19 = 300000u;
  if (!(PORT_RST_N == (tUInt8)0u))
  {
    dollar_fwrite(sim_hdl, this, "32,s,-32", 2147483650u, &__str_literal_7, DEF_signed_300000___d19);
    dollar_finish(sim_hdl, "32", 1u);
  }
}
...
unsigned int MOD_mkTestBench::dump_VCD_defs(unsigned int levels)
{
  ...
  vcd_write_def(sim_hdl, num++, "_read__h140", 32u);
...
void MOD_mkTestBench::vcd_defs(tVCDDumpType dt, MOD_mkTestBench &backing)
{
  ...
  if (dt == VCD_DUMP_XS)
  {
	...
	backing.PORT_RST_N = PORT_RST_N;
      ...
      ++num;
      if ((backing.DEF__read__h140) != DEF__read__h140)
      {
	vcd_write_val(sim_hdl, num, DEF__read__h140, 32u);
	backing.DEF__read__h140 = DEF__read__h140;
      }
      ++num;
    }
    else
